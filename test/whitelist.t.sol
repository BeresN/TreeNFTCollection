...
contract WhitelistTest is Test {
    ...
    function setUp() public {
        ...
        vm.prank(owner);
        whitelist = new Whitelist(owner, MAX_WHITELIST_SIZE);
    }
    ...
    function testConstructorWithDifferentMaxSize() public {
        ...
        vm.prank(owner);
        Whitelist customWhitelist = new Whitelist(owner, customMaxSize);
    ...
    function testFuzzMaxWhitelistSize(uint256 maxSize) public {
        ...
        vm.prank(owner);
        Whitelist fuzzWhitelist = new Whitelist(owner, maxSize);
